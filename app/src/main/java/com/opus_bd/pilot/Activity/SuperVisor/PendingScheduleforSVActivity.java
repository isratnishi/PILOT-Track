...
public class PendingScheduleforSVActivity extends AppCompatActivity {
    @BindView(R.id.rvlist)
    RecyclerView rvlist;
    int orgid;
    CancleReqListAdapter runningReqListAdapter;
    private ArrayList<RequisationListModel> requisationListModels = new ArrayList<>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pending_schedulefor_sv);
    ...
    public void intRecyclerView() {
        runningReqListAdapter = new CancleReqListAdapter(requisationListModels, this);
